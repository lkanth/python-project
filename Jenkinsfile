                ...
                script 
				{
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'HCMXUser', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) 
					{
                        ...
                        final String HCMX_REQUEST_ID = "11867"                          
                            final String HCMX_GET_SUBSCRIPTION_URL = "https://" + HCMX_SERVER_FQDN + "/rest/" + HCMX_TENANT_ID + "/ems/Subscription?filter=InitiatedByRequest=" + HCMX_REQUEST_ID + "%20and%20Status=Active\\&layout=Id"
